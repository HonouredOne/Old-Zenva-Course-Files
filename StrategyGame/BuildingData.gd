...
var base = Building.new(0, preload("res://Sprites/Base.png"), 0, 0, 1, -1)
var greenhouse = Building.new(1, preload("res://Sprites/Greenhouse.png"), 1, 1, 4, -1)
var mine = Building.new(2, preload("res://Sprites/Mine.png"), 2, 1, 1, -1)
var oxygenfarm = Building.new(3, preload("res://Sprites/OxygenFarm.png"), 3, 1, 2, -1)
var solarpanel = Building.new(4, preload("res://Sprites/SolarPanel.png"), 4, 1, 3, -1)
